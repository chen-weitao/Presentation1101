...
background-image: url('https://cdn.jsdelivr.net/gh/chen-weitao/images/test/xiaohui.jpg')
...
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_214550.png")
```
...
```{r, echo=FALSE,fig.align='center', out.width='100%'}
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_215525.png")
```
...
```{r, echo=FALSE,fig.align='center', out.width='100%'}
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_223552.png")
```
---
...
```{r, echo=FALSE,fig.align='center', out.width='100%'}
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_223746.png")
```
...
```{r, echo=FALSE,fig.align='center', out.width='100%'}
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_233741.png")
```
...
```{r, echo=FALSE,fig.align='center', out.width='100%'}
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_234358.png")
```
...
```{r, echo=FALSE,fig.align='center', out.width='100%'}
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_234417.png")
```
...
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_234924.png")
```
...
```{r, echo=FALSE,fig.align='center', out.width='95%'}
knitr::include_graphics("https://cdn.jsdelivr.net/gh/chen-weitao/images/test/2023-10-29_234948.png")
```
